   ...
   <form action="admin_shaper_add.php" method="post" autocomplete="off">
    ...
    <div class="field-wrap">      
        <label> Base:  <span class="req"></span> </label>
                <input type="number" required autocomplete="off" id= "record_base" name='record_base' value = '1' oninput="CalculateFee()"/>
    </div>
    <br>

    <div class="field-wrap">      
        <label> Rate:  <span class="req"></span> </label>
                <input type="number" required autocomplete="off" id= "record_rate" name='record_rate' value = '1' oninput="CalculateFee()"/>    
    </div>
    <br>

    <div class="field-wrap">      
        <label> Fee:  <span class="req"></span> </label>
                <input type="number" readonly autocomplete="off" id= "record_fee" name='record_fee' value = '1'/>
    </div>

    <br>     
          
      <button type="submit" class="button" id = "submitNewShaperRecord" name="submitNewShaperRecord" />Save</button>
